            ...
            <div class="container">
                <div class="d-flex">
                    ...
                    <div class="d-flex order-lg-2 ml-auto">
                        ...
                        <div class="dropdown">
                            <span class="text-default">{{ isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->email }}</span>
        ...
        <div class="container">
            <div class="row align-items-center flex-row-reverse">
                ...
                <div class="col-12 col-lg-auto mt-3 mt-lg-0 text-center">
                    <a href="https://www.oye.agency" target="_blank">oye! communication</a>
                </div>
            </div>
        </div>
    </footer>
...
<script>
    //document.getElementById('lfm').filemanager('image');
