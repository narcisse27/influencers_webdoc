...
"
        ...
        DB::table('questions')->insert([
            ...
            "response" => "REPONSE : Que ce soit en amateur ou comme professionnel, être influenceur est chronophage. Six heures de travail sont parfois nécessaire à certains blogueurs pour écrire un article sur leur blog. Paloma Tortillon peut passer deux heures juste pour poster une photo sur son compte Instagram.
...
"
        ...
        DB::table('questions')->insert([
            ...
            "response" => "REPONSE : Le numérique  ne connaît pas de frontière, et c’est un réel atout pour les influenceurs neuchâtelois. 
...
Pour Laurence Allard, sociologue et professeur à La Sorbonne, le travail de l’influenceur est de se présenter comme étant le plus authentique possible et donc si la localisation fait parti de son authenticité c’est important de la cultiver, de mettre en scène cette dimension.   
"
        ]);
        DB::table('questions')->insert([
            ...
            "response" => "REPONSE : Pas facile de se démarquer dans ce monde où la concurrence fait rage. «Il faut avoir de la patience et trouver son domaine de prédilection», analyse Paloma Tortillon. 
Alors initule de recopier et de trop s’inspirer de ce qui se fait déjà. Sur la toile, ce qui marche, c’est surtout l’originalité note la plupart des influenceurs. 
...
"
        ...
        DB::table('questions')->insert([
            ...
            "response" => "REPONSE : 
Souvent, les abonnés imaginent que la vie d’influenceur est faite de chaussures, de sacs et de produits gratuits. Mais c’est une infime partie de la réalité. La majorité de leur journée, il la passe devant leur ordinateur, à chercher du contenu qui plaise et qui fera de l’audience.
...
Pour Paloma, débutante dans le domaine, les collaborations dépendent de ses publications. Si elle ne poste aucun contenu pendant une certaine période, elle n’aura aucun mandat. Parfois, elle va elle-même contacter les marques «le monde du naturel est assez petit donc les marques me répondent souvent.»"
        ...
        DB::table('questions')->insert([
            ...
            "response" => "REPONSE : «À partir du moment où ceux-ci peuvent en vivre. Car se faire offrir des produits c’est sympathique mais cela ne permet pas de payer le loyer», lance Dan Noël. 
...
Laurence Allard voit ce milieu comme une véritable économie. L’objectif est clair : que tout le monde gagne de l’argent. « Les influenceurs mettent en avant des produits, les agents prennent un pourcentage, les marques vendent leur marchandise etc. » "
        ...
        DB::table('questions')->insert([
            ...
            "response" => "REPONSE : «Si l’influenceur tire un revenu de son activité, alors évidemment cela doit être déclaré, comme tout revenu. Si l’influenceur a gardé un travail mais fait ça à côté, cela doit être déclaré comme revenu complémentaire.» Si l'influenceur est un professionnel, il doit s'inscrire en tant qu'indépendant, «ce qui est mon cas», précise Jorge. Autre possibilité, il peut aussi créer sa propre société (SARL, SA...) qui gérera ses revenus et dont il sera salarié. 
